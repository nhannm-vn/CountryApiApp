...
document.querySelector("form").addEventListener("submit", (event) => {
    ...
    .catch(() => {
        ...
        if(countryName.length == 0){
            document.querySelector(".notification-error").textContent = "The input field cannot be empty";
            document.querySelector(".notification-error").style.display = "block";
        }else{
            document.querySelector(".notification-error").textContent = "Please enter the valid country name";
            document.querySelector(".notification-error").style.display = "block";
        }
    })
})
